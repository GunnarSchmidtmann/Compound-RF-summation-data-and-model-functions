%
%Test_PAL_SDT_Summ_MultiplePFML_SimulateObserverParametric  Simulate observer
%for a summation experiment with multiple PFs (psychometric functions)
% based on SDT (signal detection theory)
%
%Syntax: 
%
% NumPos = SDT_Summ_MultiplePFML_SimulateObserverParametric(StimLevels,gParams,pParams,OutOfNum,SummFunc,M,Q)
%
%Input:
%
...
function NumPos = Pest_PAL_SDT_Summ_MultiplePFML_SimulateObserverParametric(StimLevels,gParams,pParams,OutOfNum,SummModel,M,Q)
...
% Calculate PC for the components
