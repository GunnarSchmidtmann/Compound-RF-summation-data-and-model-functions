%
%Test_SDT_Summ_MultiplePFML_OneTau_Fit   Fits the parameters of a set of summation 
% psychometric curves using a Maximum Likelihood criterion, based on
% either a probability or additive summation model
%
% Syntax: 
% [gParamsOut, pParamsOut, negLL, exitflag, output] = SDT_Summ_MultiplePFML_OneTau_Fit(StimLevels,gParams,pParams,NumPos,OutOfNum,SummFunc,M,Q)
%
%
%Input:
%
...
% pParams=[1.5]; %Initial guesses for pA and pB
%
%Fit data:
%
%   [gParamsOut pParamOut, negLL, exitflag, output] = SDT_Summ_MultiplePFML_Fit(StimLevels,gParams,pParam,NumPos,OutOfNum,SummFunc,M,Q)
%
%
%returns:
% 
...
function [gParamsOut, pParamsOut, negLL, exitflag, output] = Test_PAL_SDT_Summ_MultiplePFML_Fit(StimLevels,gParamsIn,pParamsIn,NumPos,OutOfNum,SummModel,M,Q,varargin)
...
paramsIn=[gParamsIn pParamsIn];
paramsIn=paramsIn/CM;

[paramsOut, negLL, exitflag, output] = PAL_minimize(@Test_PAL_SDT_Summ_MultiplePFML_negLL,paramsIn,options,StimLevels,NumPos,OutOfNum,SummModel,M,Q,CM); 

paramsOut=paramsOut*CM;
